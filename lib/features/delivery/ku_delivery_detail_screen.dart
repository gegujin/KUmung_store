...
//   final String title;        // 예: 상품 카테고리/제목
//   final String sellerName;   // 거래자 이름
//   final int minutesAgo;      // 10분 전
...
//         children: [
//           // ===== 이미지 영역: 2번 사진 스타일(카드 + 고정 높이 + contain) =====
//           Card(
//             color: Colors.white,
//             margin: const EdgeInsets.fromLTRB(16, 16, 16, 8),
//             shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
//             child: SizedBox(
//               height: 300, // 필요 시 260~320에서 조정
//               child: Center(
//                 child: Image.network(
//                   args.imageUrl,
//                   fit: BoxFit.contain, // 👈 한눈에 보이도록
...
//             ),
//           ),
//           // (선택) 페이지 인디케이터 느낌의 점 1개 — 이미지가 여러 장이면 확장 가능
//           Row(
...
//                               const Text('·'),
//                               const SizedBox(width: 8),
//                               Text('${args.minutesAgo}분 전', style: t.bodyMedium),
//                             ],
//                           ),
//                           const SizedBox(height: 6),
//                           Row(
//                             children: [
//                               Text('출발: ${args.start}', style: t.bodySmall?.copyWith(color: Colors.grey[700])),
//                               const SizedBox(width: 12),
//                               Text('도착: ${args.end}', style: t.bodySmall?.copyWith(color: Colors.grey[700])),
//                             ],
//                           ),
//                         ],
//                       ),
...
//             ),
//             child: Center(
//               child: Text('위치 지도', style: t.titleMedium),
//             ),
//           ),
//         ],
//       ),
